...
<div class="storyblock">
    <div class="storyblockcontainer">
        ...
        <div class="storyblockinfo">
            <div class="infoscrollcontainer">
                <div class="storyblockinfocontainer">
                    <div class="summary scroll_on_hover">
                        <p class="metalabel">Summary:</p><p>{{ story.Summary }}</p>
                    </div>
                    <ul>
                        <li><span class="metalabel">Tags:</span>N/A</li>
                        <li><span class="metalabel">Chapters:</span>{{ story.chapters|length }}</li>
                        <li>
...
<!--
    <div class="storyblockcontainer">
        <div class="storyblocktable">
            ...
            <div class="storyblockinfo">
                <ul>
                    <li class="mininfo"><p><span class="metalabel">Summary:</span></p><p class="scroll_on_hover">{{ story.Summary }}</p></li>
                    <li><span class="metalabel">Tags:</span>N/A</li>
                    <li><span class="metalabel">Chapters:</span>{{ story.chapters|length }}</li>
                    <li>
                        <span class="metalabel">Completed:</span>{% if story.Completed %}Yes{% else %}No{% endif %}
